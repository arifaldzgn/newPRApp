...
@section('title', 'Approved PR')
@section('description', 'Approved Purchase Request page')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Approved Item Requests</h4>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            @foreach ($dataT as $dT)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a class="btn btn-primary btn-sm" href="/printTicket/{{ $dT->ticketCode }}" target="_blank"><i class="bi bi-printer"></i> Print</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
